    ...
    return {
        ...
        "endpoints": {
            ...
            "atlas": [
                ...
                "/atlas/vision",
                "/atlas/domains",
                "/atlas/prototypes/active",
                "/atlas/project-registry",
                "/atlas/project-registry/{project_id}",
                "/atlas/project-registry/search",
                "/atlas/capability-matrix",
                "/atlas/teaching-framework",
                "/atlas/academic-integration-plan",
