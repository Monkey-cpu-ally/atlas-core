...
SOURCE_PRIORITY: Dict[str, List[str]] = {
    ...
    "Creative Writing": ["library_of_congress", "openalex", "wikipedia", "wikidata"],
    "Economics": ["openalex", "library_of_congress", "wikipedia", "wikidata"],
    ...
    "Film Studies": ["library_of_congress", "openalex", "wikipedia", "wikidata"],
    "Game Design": ["github", "openalex", "arxiv", "uspto_patents", "wikipedia", "wikidata"],
    "History": ["library_of_congress", "wikipedia", "wikidata", "openalex"],
    "Mathematics": ["arxiv", "openalex", "github", "wikipedia", "wikidata"],
    "Music Theory": ["library_of_congress", "openalex", "wikipedia", "wikidata"],
    "Nanotechnology": ["nist", "arxiv", "openalex", "pubmed", "uspto_patents", "wikipedia", "wikidata"],
    "Philosophy": ["openalex", "library_of_congress", "wikipedia", "wikidata"],
    "Physics": ["arxiv", "nist", "openalex", "nasa_ntrs", "wikipedia", "wikidata"],
    "Psychology": ["pubmed", "openalex", "library_of_congress", "wikipedia", "wikidata"],
    ...
    "Visual Arts": ["library_of_congress", "openalex", "wikipedia", "wikidata"],
}
